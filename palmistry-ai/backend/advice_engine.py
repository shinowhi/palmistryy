    ...
    "sinh_dao": {
        ...
        "classes": [
...

            {
                "min": 70,
                "max": 101,
                "nhan": "Dài (Khá dồi dào đến Xuất sắc)",
    ...
    "su_nghiep": {
        ...
        "classes": [
...

            {
                "min": 35,
                "max": 70,
                "nhan": "Trung bình (Tiến triển đều)",
        ...
        "classes": [
            {
                "min": 0,
                "max": 35,
                "nhan": "Ngắn (Cần lắng nghe bản thân)",
        ...
        "classes": [
            {
                "min": 0,
                "max": 35,
                "nhan": "Ngắn (Cần thời gian tập trung)",
...

            {
                "min": 35,
                "max": 70,
                "nhan": "Trung bình (Tư duy ổn định)",
